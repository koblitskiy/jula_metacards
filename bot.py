...
async def prepare_card(callback: types.CallbackQuery):
    ...
    text = (
        ...
        "2️⃣ <b>Сделайте несколько глубоких вдохов и выдохов</b>, отпуская напряжение.\n"
        "3️⃣ <b>Позвольте себе</b> на мгновение отойти от внешних забот и сосредоточиться на <b>своих ощущениях</b> здесь и сейчас.\n"
        "4️⃣ <b>Наблюдайте за своими мыслями</b> и эмоциями, не оценивая их, просто отмечайте.\n"
