...
async def start_game(message: types.Message):
    welcome_text = (
        ...
        "используя метафорические карты как инструмент для рефлексии и личного роста."
    )
...
async def prepare_card(callback: types.CallbackQuery):
    ...
    text = (
        ...
        "2️⃣ Сделайте несколько <i>глубоких вдохов и выдохов</i>, отпуская напряжение.\n"
        "3️⃣ Позвольте себе на мгновение отойти от внешних забот и сосредоточиться на <b>своих ощущениях</b> здесь и сейчас.\n"
        "4️⃣ Наблюдайте за своими <i>мыслями и эмоциями</i>, не оценивая их, просто отмечайте.\n"
        "5️⃣ Подумайте о том, что в данный момент вызывает у вас наибольший интерес или беспокойство.\n\n"
