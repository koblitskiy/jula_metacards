...
PRACTITIONER_ID = 123456789  # Твой Telegram ID
...
async def prepare_card(callback: types.CallbackQuery):
    text = (
        ...
        "Позвольте вниманию мягко перейти внутрь себя.\n\n"
        "Отметьте, какая тема сейчас для вас наиболее актуальна.\n\n"
        "Когда будете готовы — получите карту."
    )
...
async def send_card(callback: types.CallbackQuery, state: FSMContext):
    ...
    reflection = (
        ...
        "💡 Какие эмоции откликаются?\n"
        "🔍 Что эта карта говорит о вашей ситуации?\n\n"
        "Позвольте ответам прийти естественно."
    )
